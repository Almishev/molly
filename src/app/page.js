    ...
    <>
      ...
      <section className="text-center my-16" id="about">
        ...
        <div className="text-white max-w-2xl mx-auto mt-4 flex flex-col gap-4">
          <p>
            Добре дошли в GREEK GYROS &ldquo;MOLLY Гоце Делчев&rdquo; 
             -  Място, от което можете да поръчате автентичен гирос, 
             бургери, салати и десерти. Да се насладите на приятна 
             обстановка и вежлив персонал. Нашата история започва 
             с желанието и упоритостта на двама души,
             които вървят ръка за ръка заедно, както в живота, така и в 
             желанието 
             да пресъздадът продукт от Гърция  по собствена специална технология в България, а именно в Родното им място град Гоце Делчев. От непрестанния им упорит труд можете да се насладите
