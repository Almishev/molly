    ...
    <>
      ...
      <section className="text-center my-16" id="about">
        ...
        <div className="text-white max-w-2xl mx-auto mt-4 flex flex-col gap-4">
          <p>
            Добре дошли в &ldquo;Molly&rdquo; - вашето любимо място за автентични гироси и дюнери! Нашата история започва с желанието да споделим с вас неповторими вкусове и кулинарни изживявания, които ще ви накарат да се усмихнете.
          </p>
          <p>
