    ...
    <>
      ...
      <section className="text-center my-16" id="about">
        ...
        <div className="text-white max-w-2xl mx-auto mt-4 flex flex-col gap-4">
          <p>
            Добре дошли в &ldquo;MOLLY Гоце Делчев&rdquo;  - вашето любимо място за автентични гироси и дюнери! Нашата история започва с желанието да споделим с вас неповторими вкусове и кулинарни изживявания, които ще ви накарат да се усмихнете.
          </p>
          <p>
      ...
      <section className="text-center my-8" id="contact">
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          ...
          <p className="text-white">Работно време: 10:00 - 22:00</p>
