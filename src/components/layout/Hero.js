      ...
      <div className="py-8 md:py-12">
        ...
        <p className="my-6 text-white text-md">
          ...
          Доставка в град <span className="text-blue-600 font-bold">Гоце Делчев </span>
           ...
           <span className="text-yellow-500 font-bold"> София</span>, сърцето на 
             Студентски град - улица Джон Ленън № 4.
        </p>
        <div className="flex gap-4 text-sm">
          <Link href="/menu" className="bg-yellow-500 uppercase items-center gap-2 text-black font-semibold px-4 py-2 rounded-full inline-flex hover:bg-yellow-500 hover:text-blue-600 transition-colors">
            Поръчай сега
            <Right />
          </Link>
